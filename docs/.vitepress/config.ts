...
export default defineConfig({
  title: 'Ryu Nakamura',
  description: 'Webサイト開発やデジタルコンテンツの紹介・販売を行っています。最新のYouTubeトレンドやXトレンド情報も配信中。',
  head: [
    ['link', { rel: 'icon', href: '/home.svg' }],
    ['meta', { property: 'og:title', content: 'Webサイト・デジタルコンテンツ制作 | Ryu Nakamura' }],
    ['meta',{property: 'og:description',content:'Webサイト開発やデジタルコンテンツの紹介・販売を行っています。最新のYouTubeトレンドやXトレンド情報も配信中。',},],
    ...
    ['meta',{property: 'twitter:description',content:'Webサイト開発やデジタルコンテンツの紹介・販売を行っています。最新のYouTubeトレンドやXトレンド情報も配信中。',},],
